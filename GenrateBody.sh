...
<div class="$QUOTE"btn btn-dark btn-xs showlayer"$QUOTE" data-img="$QUOTE"$PNGHTTP"$QUOTE" data-original-title="$QUOTE""$LayerHumanShortName""$QUOTE" data-toggle="$QUOTE"popover"$QUOTE" layer="$QUOTE"add_planche_$NomMachine"$QUOTE" addlayertolist="$QUOTE"$TiffPrivatePath"$QUOTE">Voir</div>
