...
cat GeoRef_Ony_IDC_600_400.sh | tr -d '\n' | sed 's/elif \[\[ "$TiffSource"/\
...
echo "$planche_name|$OldName|$Seine|$lefttop|$leftbottom|$righttop|$rightbottom|$lefttop3857|$leftbottom3857|$rightbottom3857|$righttop3857|$lefttop4326|$leftbottom4326|$rightbottom4326|$righttop4326|Polygon (($lefttop3857, $leftbottom3857, $rightbottom3857, $righttop3857, $lefttop3857))"|sed 's/_Source_Standard_Croped_TIFF\///g' >> tmp/List_Special_Planches.csv
